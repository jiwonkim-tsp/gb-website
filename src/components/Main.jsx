...
const Main = () => {
  return (
    <main className="p-3">
      ...
      <div className="mt-4 flex flex-col md:flex-row gap-5 md:gap-10 justify-end items-start lg:mt-10 ">
        <div className="text-[2.8vw] leading-tight text-right mt-2 break-keep text-[#403F3C] font-[NanumSquare] md:text-xl">
          전염병 등이 유행하는 상황에서 비대면으로 스마트폰의 웹을 통해 증상에
          대한 질문과 해당 답변에 대한 이동 동선을 제시해 주는
          <br /> <span className="font-bold">AR 솔루션</span>
        </div>
        <img className="w-full md:w-3/5" src={main} alt="covid 19" />
      </div>
      ...
      <div className="mt-5 flex flex-col md:flex-row gap-5 md:gap-10 justify-start items-start lg:mt-10 mb-20">
        <img className="w-full md:w-3/6 mt-0" src={main2} alt="covid 19" />
        <div className=" text-[2.8vw] leading-tight font-[NanumSquare] mb-3 mt-3 pl-4 md:pl-0 leading-12 text-left break-keep text-[#403F3C] md:text-xl">
          포토그래메트리 3D 스캔을 위한
