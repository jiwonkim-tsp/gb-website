...
const Solutions = () => {
  return (
    <div className="p-10 md:p-20 text-[#403F3C] flex flex-col justify-start">
      <div className="flex flex-col items-end">
        <h1 className="text-2xl font-bold p-7 font-[Gotham]">AR Covid 19</h1>
        <div className="w-full lg:w-3/6 leading-7 break-keep text-lg text-right mb-10 font-[NanumSquare] ">
      ...
      <div className="w-full lg:w-3/4 mt-7 mb-10">
